...
const supabaseUrl = import.meta.env.VITE_Bolt_Database_URL || import.meta.env.VITE_PUBLIC_SUPABASE_URL;
const supabaseKey = import.meta.env.VITE_Bolt_Database_ANON_KEY || import.meta.env.VITE_PUBLIC_SUPABASE_ANON_KEY;
